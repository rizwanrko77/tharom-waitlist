...
var init_setCredentialFeature = __esm({
  "../node_modules/@aws-sdk/core/dist-es/submodules/client/setCredentialFeature.js"() {
    init_functionsRoutes_0_9754267162057737();
...
var init_waiter2 = __esm({
  "../node_modules/@smithy/core/dist-es/submodules/client/util-waiter/waiter.js"() {
    ...
    checkExceptions = /* @__PURE__ */ __name((result) => {
...
var init_poller = __esm({
  "../node_modules/@smithy/core/dist-es/submodules/client/util-waiter/poller.js"() {
    ...
    init_sleep();
    init_waiter2();
    runPolling = /* @__PURE__ */ __name(async ({ minDelay, maxDelay, maxWaitTime, abortController, client, abortSignal }, input, acceptorChecks) => {
    ...
    checkWarn403 = /* @__PURE__ */ __name((observedResponses = {}, client) => {
    ...
    createMessageFromResponse = /* @__PURE__ */ __name((reason) => {
    ...
    exponentialBackoffWithJitter = /* @__PURE__ */ __name((minDelayMs, maxDelayMs, attempt, waitUntil) => {
    ...
    randomInRange = /* @__PURE__ */ __name((min, max) => min + Math.random() * (max - min), "randomInRange");
  }
});
...
var init_createWaiter = __esm({
  "../node_modules/@smithy/core/dist-es/submodules/client/util-waiter/createWaiter.js"() {
    ...
    init_validate();
    init_waiter2();
    abortTimeout = /* @__PURE__ */ __name((abortSignal) => {
      let onAbort;
      const promise = new Promise((resolve) => {
        onAbort = /* @__PURE__ */ __name(() => resolve({ state: WaiterState.ABORTED }), "onAbort");
    ...
    createWaiter = /* @__PURE__ */ __name(async (options, input, acceptorChecks) => {
      const params = {
        ...waiterServiceDefaults,
        ...options
      };
...
var defaultSESHttpAuthSchemeParametersProvider, defaultSESHttpAuthSchemeProvider, resolveHttpAuthSchemeConfig;
var init_httpAuthSchemeProvider = __esm({
  "../node_modules/@aws-sdk/client-ses/dist-es/auth/httpAuthSchemeProvider.js"() {
    init_functionsRoutes_0_9754267162057737();
    init_httpAuthSchemes2();
    init_client3();
    defaultSESHttpAuthSchemeParametersProvider = /* @__PURE__ */ __name(async (config, context, input) => {
      return {
    ...
    defaultSESHttpAuthSchemeProvider = /* @__PURE__ */ __name((authParameters) => {
      const options = [];
...
var AccountSendingPausedException, AlreadyExistsException, CannotDeleteException, LimitExceededException, RuleSetDoesNotExistException, ConfigurationSetAlreadyExistsException, ConfigurationSetDoesNotExistException, ConfigurationSetSendingPausedException, InvalidConfigurationSetException, EventDestinationAlreadyExistsException, InvalidCloudWatchDestinationException, InvalidFirehoseDestinationException, InvalidSNSDestinationException, InvalidTrackingOptionsException, TrackingOptionsAlreadyExistsException, CustomVerificationEmailInvalidContentException, CustomVerificationEmailTemplateAlreadyExistsException, FromEmailAddressNotVerifiedException, InvalidLambdaFunctionException, InvalidS3ConfigurationException, InvalidSnsTopicException, RuleDoesNotExistException, InvalidTemplateException, CustomVerificationEmailTemplateDoesNotExistException, EventDestinationDoesNotExistException, TrackingOptionsDoesNotExistException, TemplateDoesNotExistException, InvalidDeliveryOptionsException, InvalidPolicyException, InvalidRenderingParameterException, MailFromDomainNotVerifiedException, MessageRejected, MissingRenderingAttributeException, ProductionAccessNotGrantedException;
...
var _A, _AD, _AEE, _AHA, _ASPE, _Ac, _Act, _B, _BA, _BAc, _BED, _BEDL, _BEDS, _BEDSL, _BN, _BOMXF, _BRI, _BRIL, _BS, _BSA, _BT, _BTo, _Bo, _Bou, _C, _CA, _CAc, _CCS, _CCSED, _CCSEDR, _CCSEDRr, _CCSR, _CCSRr, _CCSTO, _CCSTOR, _CCSTORr, _CCVET, _CCVETR, _CDE, _CRD, _CRF, _CRFR, _CRFRr, _CRR, _CRRR, _CRRRr, _CRRS, _CRRSR, _CRRSRl, _CRRSRr, _CRRSRre, _CRRSr, _CS, _CSAEE, _CSAN, _CSDNEE, _CSN, _CSSPE, _CSo, _CT, _CTR, _CTRr, _CTr, _CTre, _CVEICE, _CVET, _CVETAEE, _CVETDNEE, _CVETN, _CVETu, _CWD, _CWDC, _CWDCl, _Ch, _Ci, _Co, _D, _DA, _DARRS, _DARRSR, _DARRSRe, _DAe, _DC, _DCS, _DCSED, _DCSEDR, _DCSEDRe, _DCSR, _DCSRe, _DCSRes, _DCSResc, _DCSTO, _DCSTOR, _DCSTORe, _DCSe, _DCVET, _DCVETR, _DCi, _DDV, _DE, _DI, _DIP, _DIPR, _DIPRe, _DIR, _DIRe, _DN, _DO, _DRF, _DRFR, _DRFRe, _DRR, _DRRR, _DRRRe, _DRRRes, _DRRResc, _DRRS, _DRRSR, _DRRSRe, _DRRSRes, _DRRSResc, _DRRSe, _DRRe, _DSARN, _DT, _DTD, _DTR, _DTRe, _DTe, _DTef, _DTel, _DVEA, _DVEAR, _DVS, _DVSk, _Da, _De, _Do, _E, _EA, _ED, _EDAEE, _EDDNEE, _EDN, _EDv, _EF, _EFL, _EFx, _En, _Enc, _Ex, _F, _FA, _FAr, _FE, _FEA, _FEANVE, _FN, _FR, _FRURL, _Fi, _GASE, _GASER, _GCVET, _GCVETR, _GCVETRe, _GIDA, _GIDAR, _GIDARe, _GIMFDA, _GIMFDAR, _GIMFDARe, _GINA, _GINAR, _GINARe, _GIP, _GIPR, _GIPRe, _GIVA, _GIVAR, _GIVARe, _GSQ, _GSQR, _GSS, _GSSR, _GT, _GTR, _GTRe, _H, _HIBNE, _HICNE, _HIDNE, _HN, _HP, _HV, _I, _IAMRARN, _IARN, _ICSE, _ICWDE, _IDA, _IDOE, _IF, _IFDE, _ILFE, _IMFDA, _INA, _IPE, _IRA, _IRPE, _ISCE, _ISNSDE, _ISTE, _IT, _ITE, _ITOE, _ITd, _IVA, _Id, _KFD, _KKA, _LA, _LAD, _LCS, _LCSR, _LCSRi, _LCVET, _LCVETR, _LCVETRi, _LEE, _LFS, _LI, _LIP, _LIPR, _LIPRi, _LIR, _LIRi, _LRF, _LRFR, _LRFRi, _LRRS, _LRRSR, _LRRSRi, _LT, _LTR, _LTRi, _LVEA, _LVEAR, _M, _MD, _MET, _MFD, _MFDA, _MFDNVE, _MFDS, _MHS, _MI, _MIa, _MR, _MRAE, _MRa, _MSR, _MT, _MTL, _Me, _N, _NA, _NT, _NTo, _OA, _OKP, _OMI, _ORSN, _P, _PANGE, _PCSDO, _PCSDOR, _PCSDORu, _PIP, _PIPR, _PIPRu, _PN, _PNo, _Po, _R, _RA, _RAL, _RAe, _RDF, _RDNEE, _RF, _RFL, _RIF, _RM, _RME, _RMa, _RMe, _RN, _RNu, _RO, _RP, _RPA, _RR, _RRL, _RRRS, _RRRSR, _RRRSRe, _RRSL, _RRSM, _RS, _RSDNEE, _RSN, _RT, _RTA, _RTD, _RTe, _Re, _Rej, _Ru, _Rul, _S, _SA, _SARRS, _SARRSR, _SARRSRe, _SAo, _SAt, _SB, _SBR, _SBRe, _SBTE, _SBTER, _SBTERe, _SC, _SCVE, _SCVER, _SCVERe, _SDP, _SDPL, _SDPe, _SE, _SER, _SERe, _SEe, _SEen, _SIDE, _SIDER, _SIDERe, _SIFFE, _SIFFER, _SIFFERe, _SIHINE, _SIHINER, _SIHINERe, _SIMFD, _SIMFDR, _SIMFDRe, _SINT, _SINTR, _SINTRe, _SLH, _SNSA, _SNSD, _SP, _SRC, _SRE, _SRER, _SRERe, _SRRP, _SRRPR, _SRRPRe, _SRURL, _ST, _STE, _STER, _STERe, _Sc, _So, _St, _Su, _T, _TA, _TARN, _TAe, _TAo, _TC, _TD, _TDNEE, _TM, _TML, _TMe, _TN, _TO, _TOAEE, _TODNEE, _TP, _TPe, _TRT, _TRTR, _TRTRe, _TS, _Ta, _Te, _Tem, _Ti, _UASE, _UASER, _UCSED, _UCSEDR, _UCSEDRp, _UCSRME, _UCSRMER, _UCSSE, _UCSSER, _UCSTO, _UCSTOR, _UCSTORp, _UCVET, _UCVETR, _URR, _URRR, _URRRp, _UT, _UTR, _UTRp, _V, _VA, _VDD, _VDDR, _VDDRe, _VDI, _VDIR, _VDIRe, _VEA, _VEAR, _VEAe, _VEI, _VEIR, _VEIRe, _VS, _VT, _WA, _aQE, _c, _e, _hE, _m, _s, n0, _s_registry, SESServiceException$, n0_registry, AccountSendingPausedException$, AlreadyExistsException$, CannotDeleteException$, ConfigurationSetAlreadyExistsException$, ConfigurationSetDoesNotExistException$, ConfigurationSetSendingPausedException$, CustomVerificationEmailInvalidContentException$, CustomVerificationEmailTemplateAlreadyExistsException$, CustomVerificationEmailTemplateDoesNotExistException$, EventDestinationAlreadyExistsException$, EventDestinationDoesNotExistException$, FromEmailAddressNotVerifiedException$, InvalidCloudWatchDestinationException$, InvalidConfigurationSetException$, InvalidDeliveryOptionsException$, InvalidFirehoseDestinationException$, InvalidLambdaFunctionException$, InvalidPolicyException$, InvalidRenderingParameterException$, InvalidS3ConfigurationException$, InvalidSNSDestinationException$, InvalidSnsTopicException$, InvalidTemplateException$, InvalidTrackingOptionsException$, LimitExceededException$, MailFromDomainNotVerifiedException$, MessageRejected$, MissingRenderingAttributeException$, ProductionAccessNotGrantedException$, RuleDoesNotExistException$, RuleSetDoesNotExistException$, TemplateDoesNotExistException$, TrackingOptionsAlreadyExistsException$, TrackingOptionsDoesNotExistException$, errorTypeRegistries, AddHeaderAction$, Body$, BounceAction$, BouncedRecipientInfo$, BulkEmailDestination$, BulkEmailDestinationStatus$, CloneReceiptRuleSetRequest$, CloneReceiptRuleSetResponse$, CloudWatchDestination$, CloudWatchDimensionConfiguration$, ConfigurationSet$, ConnectAction$, Content$, CreateConfigurationSetEventDestinationRequest$, CreateConfigurationSetEventDestinationResponse$, CreateConfigurationSetRequest$, CreateConfigurationSetResponse$, CreateConfigurationSetTrackingOptionsRequest$, CreateConfigurationSetTrackingOptionsResponse$, CreateCustomVerificationEmailTemplateRequest$, CreateReceiptFilterRequest$, CreateReceiptFilterResponse$, CreateReceiptRuleRequest$, CreateReceiptRuleResponse$, CreateReceiptRuleSetRequest$, CreateReceiptRuleSetResponse$, CreateTemplateRequest$, CreateTemplateResponse$, CustomVerificationEmailTemplate$, DeleteConfigurationSetEventDestinationRequest$, DeleteConfigurationSetEventDestinationResponse$, DeleteConfigurationSetRequest$, DeleteConfigurationSetResponse$, DeleteConfigurationSetTrackingOptionsRequest$, DeleteConfigurationSetTrackingOptionsResponse$, DeleteCustomVerificationEmailTemplateRequest$, DeleteIdentityPolicyRequest$, DeleteIdentityPolicyResponse$, DeleteIdentityRequest$, DeleteIdentityResponse$, DeleteReceiptFilterRequest$, DeleteReceiptFilterResponse$, DeleteReceiptRuleRequest$, DeleteReceiptRuleResponse$, DeleteReceiptRuleSetRequest$, DeleteReceiptRuleSetResponse$, DeleteTemplateRequest$, DeleteTemplateResponse$, DeleteVerifiedEmailAddressRequest$, DeliveryOptions$, DescribeActiveReceiptRuleSetRequest$, DescribeActiveReceiptRuleSetResponse$, DescribeConfigurationSetRequest$, DescribeConfigurationSetResponse$, DescribeReceiptRuleRequest$, DescribeReceiptRuleResponse$, DescribeReceiptRuleSetRequest$, DescribeReceiptRuleSetResponse$, Destination$, EventDestination$, ExtensionField$, GetAccountSendingEnabledResponse$, GetCustomVerificationEmailTemplateRequest$, GetCustomVerificationEmailTemplateResponse$, GetIdentityDkimAttributesRequest$, GetIdentityDkimAttributesResponse$, GetIdentityMailFromDomainAttributesRequest$, GetIdentityMailFromDomainAttributesResponse$, GetIdentityNotificationAttributesRequest$, GetIdentityNotificationAttributesResponse$, GetIdentityPoliciesRequest$, GetIdentityPoliciesResponse$, GetIdentityVerificationAttributesRequest$, GetIdentityVerificationAttributesResponse$, GetSendQuotaResponse$, GetSendStatisticsResponse$, GetTemplateRequest$, GetTemplateResponse$, IdentityDkimAttributes$, IdentityMailFromDomainAttributes$, IdentityNotificationAttributes$, IdentityVerificationAttributes$, KinesisFirehoseDestination$, LambdaAction$, ListConfigurationSetsRequest$, ListConfigurationSetsResponse$, ListCustomVerificationEmailTemplatesRequest$, ListCustomVerificationEmailTemplatesResponse$, ListIdentitiesRequest$, ListIdentitiesResponse$, ListIdentityPoliciesRequest$, ListIdentityPoliciesResponse$, ListReceiptFiltersRequest$, ListReceiptFiltersResponse$, ListReceiptRuleSetsRequest$, ListReceiptRuleSetsResponse$, ListTemplatesRequest$, ListTemplatesResponse$, ListVerifiedEmailAddressesResponse$, Message$, MessageDsn$, MessageTag$, PutConfigurationSetDeliveryOptionsRequest$, PutConfigurationSetDeliveryOptionsResponse$, PutIdentityPolicyRequest$, PutIdentityPolicyResponse$, RawMessage$, ReceiptAction$, ReceiptFilter$, ReceiptIpFilter$, ReceiptRule$, ReceiptRuleSetMetadata$, RecipientDsnFields$, ReorderReceiptRuleSetRequest$, ReorderReceiptRuleSetResponse$, ReputationOptions$, S3Action$, SendBounceRequest$, SendBounceResponse$, SendBulkTemplatedEmailRequest$, SendBulkTemplatedEmailResponse$, SendCustomVerificationEmailRequest$, SendCustomVerificationEmailResponse$, SendDataPoint$, SendEmailRequest$, SendEmailResponse$, SendRawEmailRequest$, SendRawEmailResponse$, SendTemplatedEmailRequest$, SendTemplatedEmailResponse$, SetActiveReceiptRuleSetRequest$, SetActiveReceiptRuleSetResponse$, SetIdentityDkimEnabledRequest$, SetIdentityDkimEnabledResponse$, SetIdentityFeedbackForwardingEnabledRequest$, SetIdentityFeedbackForwardingEnabledResponse$, SetIdentityHeadersInNotificationsEnabledRequest$, SetIdentityHeadersInNotificationsEnabledResponse$, SetIdentityMailFromDomainRequest$, SetIdentityMailFromDomainResponse$, SetIdentityNotificationTopicRequest$, SetIdentityNotificationTopicResponse$, SetReceiptRulePositionRequest$, SetReceiptRulePositionResponse$, SNSAction$, SNSDestination$, StopAction$, Template$, TemplateMetadata$, TestRenderTemplateRequest$, TestRenderTemplateResponse$, TrackingOptions$, UpdateAccountSendingEnabledRequest$, UpdateConfigurationSetEventDestinationRequest$, UpdateConfigurationSetEventDestinationResponse$, UpdateConfigurationSetReputationMetricsEnabledRequest$, UpdateConfigurationSetSendingEnabledRequest$, UpdateConfigurationSetTrackingOptionsRequest$, UpdateConfigurationSetTrackingOptionsResponse$, UpdateCustomVerificationEmailTemplateRequest$, UpdateReceiptRuleRequest$, UpdateReceiptRuleResponse$, UpdateTemplateRequest$, UpdateTemplateResponse$, VerifyDomainDkimRequest$, VerifyDomainDkimResponse$, VerifyDomainIdentityRequest$, VerifyDomainIdentityResponse$, VerifyEmailAddressRequest$, VerifyEmailIdentityRequest$, VerifyEmailIdentityResponse$, WorkmailAction$, __Unit, AddressList, BouncedRecipientInfoList, BulkEmailDestinationList, BulkEmailDestinationStatusList, CloudWatchDimensionConfigurations, ConfigurationSetAttributeList, ConfigurationSets, CustomVerificationEmailTemplates, EventDestinations, EventTypes, ExtensionFieldList, IdentityList, MessageTagList, PolicyNameList, ReceiptActionsList, ReceiptFilterList, ReceiptRuleNamesList, ReceiptRuleSetsLists, ReceiptRulesList, RecipientsList, SendDataPointList, TemplateMetadataList, VerificationTokenList, DkimAttributes, MailFromDomainAttributes, NotificationAttributes, PolicyMap, VerificationAttributes, CloneReceiptRuleSet$, CreateConfigurationSet$, CreateConfigurationSetEventDestination$, CreateConfigurationSetTrackingOptions$, CreateCustomVerificationEmailTemplate$, CreateReceiptFilter$, CreateReceiptRule$, CreateReceiptRuleSet$, CreateTemplate$, DeleteConfigurationSet$, DeleteConfigurationSetEventDestination$, DeleteConfigurationSetTrackingOptions$, DeleteCustomVerificationEmailTemplate$, DeleteIdentity$, DeleteIdentityPolicy$, DeleteReceiptFilter$, DeleteReceiptRule$, DeleteReceiptRuleSet$, DeleteTemplate$, DeleteVerifiedEmailAddress$, DescribeActiveReceiptRuleSet$, DescribeConfigurationSet$, DescribeReceiptRule$, DescribeReceiptRuleSet$, GetAccountSendingEnabled$, GetCustomVerificationEmailTemplate$, GetIdentityDkimAttributes$, GetIdentityMailFromDomainAttributes$, GetIdentityNotificationAttributes$, GetIdentityPolicies$, GetIdentityVerificationAttributes$, GetSendQuota$, GetSendStatistics$, GetTemplate$, ListConfigurationSets$, ListCustomVerificationEmailTemplates$, ListIdentities$, ListIdentityPolicies$, ListReceiptFilters$, ListReceiptRuleSets$, ListTemplates$, ListVerifiedEmailAddresses$, PutConfigurationSetDeliveryOptions$, PutIdentityPolicy$, ReorderReceiptRuleSet$, SendBounce$, SendBulkTemplatedEmail$, SendCustomVerificationEmail$, SendEmail$, SendRawEmail$, SendTemplatedEmail$, SetActiveReceiptRuleSet$, SetIdentityDkimEnabled$, SetIdentityFeedbackForwardingEnabled$, SetIdentityHeadersInNotificationsEnabled$, SetIdentityMailFromDomain$, SetIdentityNotificationTopic$, SetReceiptRulePosition$, TestRenderTemplate$, UpdateAccountSendingEnabled$, UpdateConfigurationSetEventDestination$, UpdateConfigurationSetReputationMetricsEnabled$, UpdateConfigurationSetSendingEnabled$, UpdateConfigurationSetTrackingOptions$, UpdateCustomVerificationEmailTemplate$, UpdateReceiptRule$, UpdateTemplate$, VerifyDomainDkim$, VerifyDomainIdentity$, VerifyEmailAddress$, VerifyEmailIdentity$;
...
var checkState, waitUntilIdentityExists;
var init_waitForIdentityExists = __esm({
  "../node_modules/@aws-sdk/client-ses/dist-es/waiters/waitForIdentityExists.js"() {
    ...
    waitUntilIdentityExists = /* @__PURE__ */ __name(async (params, input) => {
...
var commands, paginators, waiters, SES;
var init_SES = __esm({
  "../node_modules/@aws-sdk/client-ses/dist-es/SES.js"() {
    init_functionsRoutes_0_9754267162057737();
    init_client3();
...
// ../.wrangler/tmp/pages-CNMPkH/functionsRoutes-0.9754267162057737.mjs
var routes;
var init_functionsRoutes_0_9754267162057737 = __esm({
  "../.wrangler/tmp/pages-CNMPkH/functionsRoutes-0.9754267162057737.mjs"() {
    init_waitlist();
    routes = [
      {
...
// ../.wrangler/tmp/bundle-hGkC9E/middleware-loader.entry.ts
init_functionsRoutes_0_9754267162057737();

// ../.wrangler/tmp/bundle-hGkC9E/middleware-insertion-facade.js
init_functionsRoutes_0_9754267162057737();
...
//# sourceMappingURL=functionsWorker-0.7780878864064402.mjs.map
